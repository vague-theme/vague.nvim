...
M.get_colors = function(conf)
  ...
  local hl = {
    ...
    CmpItemAbbrMatch      = { fg = c.delta, bold = conf.bold },      -- matched text in completion menu
    CmpItemAbbrMatchFuzzy = { fg = c.delta, bold = conf.bold },      -- fuzzy-matched text in completion menu
