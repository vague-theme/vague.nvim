...
M.get_colors = function(conf)
  ...
  local hl = {
    ...
    NeoTreeRootName           = { fg = c.hint, bold = conf.bold },                                      -- root directory name in NeoTree
    ...
    NeoTreeGitConflict        = { fg = c.error, bold = conf.bold, italic = conf.italic },                              -- Git conflict in NeoTree
    NeoTreeGitUntracked       = { fg = c.error, italic = conf.italic },                                   -- untracked Git files in NeoTree
